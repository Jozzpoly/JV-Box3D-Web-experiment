...
> **Repository navigation guard:** `main` is a minimal historical root. It is **not** the current JV Web product, release candidate, or implementation base.
...
```text
GitHub Pages: NOT PUBLISHED
public artifact: NOT YET PROVEN
product branch: PRESERVED / UNCHANGED
```

The active campaign is building a reproducible map-only browser release before publishing a static artifact and before resuming the real chassis/four-wheel integration.

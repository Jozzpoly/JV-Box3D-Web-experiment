...
Status: `HISTORICAL INCOMPLETE ATTEMPT / SUPERSEDED`
...
Head recorded by the original receipt:

```text
f7c672e154fb3f4e21d4342dd47554a31733d0f4
```

Both steering and longitudinal keyboard adapters clamp every emitted event timestamp to:
...
This receipt is preserved unchanged in meaning and is superseded by the later validated reference baseline.
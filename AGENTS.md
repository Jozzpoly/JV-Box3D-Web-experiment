...
- C0-CHAR is closed for exact `746dda0b09aeb0906412ef8a2d110a6f3fa83561`, tree `db9eadf45f75784314d62ae8caf1db528e1de622`: two independent Windows 11 x64 runs on Node 24.16.0 / npm 11.13.0 / TypeScript 7.0.2 / Vite 8.1.5 reached 287/287 tests, 18 documentation links and byte-identical 14-file LOCAL_FULL portable artifacts; both disposable worktrees were removed. External evidence ZIP SHA-256: `f1e6b385cca9e80517c57e8c5680fd5f794a0f6a1d1337bc61b304d356520a80`. This is the last validated predecessor for C1. Linux remains outside the R0 guarantee and is not a release gate.
- The C1 tip containing this file is `SOURCE-PRESENT / REVALIDATION REQUIRED`. It may split the scan dependency boundary only; it must not claim LOCAL_FULL runtime equivalence until its own exact Windows gate and browser regression pass.

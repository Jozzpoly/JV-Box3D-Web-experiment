...
const torusSelected =
  MODE5_WHEEL_GEOMETRY_VARIANT === MODE5_CORE_TORUS_GEOMETRY;

test(
  "full M6 settles and drives with the exact CORE torus selected",
  { skip: torusSelected ? false : "requires a core-torus64-selected compile" },
  async () => {
    assert.equal(MODE5_WHEEL_GEOMETRY_VARIANT, MODE5_CORE_TORUS_GEOMETRY);
